          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <span className={`text-xs font-medium px-2 py-1 rounded ${statusColors[cap.status]}`}>
                  {cap.status.replace("_", " ")}
                </span>
              </div>
              <h3 className="text-sm font-medium text-gray-900 mt-2">{cap.title}</h3>
